...
int main()
{
 ...
 %===========================================================*/
 InitializeEquation(n_node,n_pre_disp,dof_node, disp_node,eq_num, n_dof,total_dof );
 
 /*==========================================================;
 %                 Assemble Module                            ;
 %===========================================================*/
 AssembleModule( edof, n_dof, total_dof, ndim, dof_node,
                     n_elem, n_load, n_pre_disp,  nnode_ele, coords,
                     elem_node, elem_stiff, elem_load,
                     elem_area,  force_node,
                     force_val,  disp_node,  disp_val,
                     n_trac_q, trac_q_ele,  trac_q_val,
                     n_trac_c, trac_c_ele, trac_c_val,
                     Ng, ShapeOrder,
                     eq_num, Kff,Kpp, Kpf, Kfp,
                     Pf, Pp,Uf, Up );
// cout<<Kff;
